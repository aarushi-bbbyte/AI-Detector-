...
import "./App.css";
import PlagiarismChecker from "./PlagiarismChecker.jsx";
            ...
            <div className="result-card">
              <div className="result-card-header">
                ...
                <div className="result-card-actions">
                  <button className="download-btn" onClick={() => downloadReport(viewingResult, {
                    filename: viewingResult.filename,
                    versionLabel: viewingResult.version_label,
                    submitted_at: viewingResult.submitted_at,
                    textPreview: viewingResult.text_preview,
                  })}>⬇ Download PDF</button>
          ...
          {phase === "done" && result && (
            <div className="result-card">
              <div className="result-card-header">
                ...
                <div className="result-card-actions">
                  <button className="download-btn" onClick={() => downloadReport(result, {
                    filename: filename,
                    versionLabel: versionLabel,
